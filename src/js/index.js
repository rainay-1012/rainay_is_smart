...
import { getCurrentUserToken } from "./authentication.js";
import "./dev_dashboard.js";
import { initDeveloper } from "./dev_dashboard.js";
import "./exec_dashboard.js";
import { initExecutiveDashboard } from "./exec_dashboard.js";
import { initLogin } from "./login.js";
import { initManager } from "./mgr_dashboard.js";
import "./profile.js";
import { initProfile } from "./profile.js";
import { initRegister } from "./register.js";
import "./vendor_add.js";
import "./vendor_management.js";
import { initVendorManagement } from "./vendor_management.js";
...
export const routes = {
  ...
  vendor: {
    path: "/manager_dashboard/vendor_management",
    destination: "#content",
    parent: "manager",
    init: initVendorManagement,
  },
  profile: {
    path: "/manager_dashboard/profile",
    destination: "#content",
    parent: "manager",
    init: initProfile,
  },
...
$(async function () {
  ...
  const redirectUrl = $("meta[name='redirect-url']").attr("content");
  let route;

  if (redirectUrl) {
    route = getRouteFromPath(redirectUrl);
  } else {
