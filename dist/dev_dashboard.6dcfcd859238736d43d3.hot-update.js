...
jquery__WEBPACK_IMPORTED_MODULE_10___default()(function () {
  ...
  tokenTable.on("click", "tbody tr", function (e) {
    e.currentTarget.classList.toggle("selected");
  });

  document.querySelector("#button").addEventListener("click", function () {
    alert(tokenTable.rows(".selected").data().length + " row(s) selected");
  });
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("aa204b4e400d2fdcf6e9")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=dev_dashboard.6dcfcd859238736d43d3.hot-update.js.map