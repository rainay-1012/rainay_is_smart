...
jquery__WEBPACK_IMPORTED_MODULE_10___default()(function () {
  ...
  const primaryColor = rootStyles.getPropertyValue("--bs-info").trim();
    ...
    series: [
      {
        ...
        data: [
          ...
          { value: 580, name: "Inactive", itemStyle: { color: successColor } },
          { value: 735, name: "Expired", itemStyle: { color: warningColor } },
        ],
      },
    ],
  });
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("4a20599dc30b2ec84f04")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=dev_dashboard.053b7381b7dbc46d9f72.hot-update.js.map