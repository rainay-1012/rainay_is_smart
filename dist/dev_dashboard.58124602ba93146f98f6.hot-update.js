...
jquery__WEBPACK_IMPORTED_MODULE_10___default()(function () {
  ...
  function randomData() {
    ...
    return {
      name: now.toString(),
      value: [[now.getMonth() + 1, now.getDate()].join("/"), Math.round(value)],
    };
  }

  function randomData() {
    now = new Date(+now + oneDay);
    value = value + Math.random() * 200 - 100; // Larger fluctuation, change range from -100 to 100
    return {
      name: now.toString(),
      value: [
        [now.getMonth() + 1, now.getDate()].join("/"), // Only month and day
        Math.round(value),
      ],
    };
  }
  ...
  let value = Math.random() * 1000; // Start with a larger initial value
    ...
    yAxis: {
      ...
      axisLabel: {
        formatter: function (value) {
          return echarts__WEBPACK_IMPORTED_MODULE_9__.time.format("MM/dd", value); // Only month and day on axis
        },
      },
    },
    series: [
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("7d256c3b9fb8ea5bdbdf")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=dev_dashboard.58124602ba93146f98f6.hot-update.js.map