...
jquery__WEBPACK_IMPORTED_MODULE_10___default()(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_10___default()("#example tbody").on("click", "tr", function () {
    ...
    document.getElementById("_package").value = data[3];
    document.getElementById("_name").value = data[0];
    document.getElementById("_email").value = data[1];
    document.getElementById("_address").value = data[2];
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("4f82d051fbcc0f12b256")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=dev_dashboard.1bdc89102d4e7d1eefed.hot-update.js.map